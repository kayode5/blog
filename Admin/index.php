...
$sql = "SELECT * FROM post"; //select all from the table blog
						...
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									...
									<h3 class="mb-0 number-font"><?php echo $count1 ?></h3>
								</div>
								<div class="col-auto mb-0">
							...
							<span class="fs-12 text-muted"> <strong></strong><i class="mdi mdi-arrow-up"></i> <span class="text-muted fs-12 ml-0 mt-1">Total Number Of Authors</span></span>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6">
						...
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									...
									<h3 class="mb-0 number-font"><?php echo $count2 ?></h3>
								</div>
								<div class="col-auto mb-0">
							...
							<span class="fs-12 text-muted"> <strong></strong><i class="mdi mdi-arrow-up"></i> <span class="text-muted fs-12 ml-0 mt-1">Total Number of Users</span></span>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6">
