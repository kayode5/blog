								...
								<table class="table table-bordered table-hover mb-0 text-nowrap">
                        			...
                        			while($row=mysqli_fetch_array($query))
										...
										<tr>
											...
											<td><img src="<?php echo $row['image']; ?>" style="height:80px;width:99px" alt=""></td>
										<td>
												<a href="edit_category.php?id=<?php echo $id?>" class="btn btn-primary btn-sm text-white mb-1" data-original-title="View" data-toggle="tooltip"><i class="fa fa-eye"></i></a> <a href="delete_category.php?id=<?php echo $id?>" class="btn btn-danger btn-sm text-white mb-1" data-original-title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a><br>
											</td>
										</tr>
											<?php } ?>
									</tbody>
